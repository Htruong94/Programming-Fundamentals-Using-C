...
int main(void)
{
    ...
    struct Contact UserInfo = { { {" "} }, { 0,"",0,"","" }, { {""} } }; //initializing all structures within contact structure to empty c strings and int to 0
    ...
    getName(&UserInfo.name); //function call getName in UserInfo structure

    // Call the Contact function getAddress to store the values for the Address member
    getAddress(&UserInfo.address); //function call getAddress in UserInfo structure

    // Call the Contact function getNumbers to store the values for the Numbers member
    getNumbers(&UserInfo.numbers); //function call getNumbers in UserInfo structure
    ...
    printf("-------------\n");
    printf("Cell phone number: %s\n", UserInfo.numbers.cell);
    printf("Home phone number: %s\n", UserInfo.numbers.home);
    printf("Business phone number: %s\n\n", UserInfo.numbers.business);
